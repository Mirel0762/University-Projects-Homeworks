    ...
    if($result = mysqli_query($conn, $sql)){  
       ...
       <div class=" " style="width: 22rem" style="display: inline-block;">
            ...
            <div class="card-block ">
                ...
                <div class="card-footer " style="font-family:'Trebuchet MS', sans-serif;font-size: 16px;text-align: center;background-color: white;">
                    <form action="sterge-produs.php" method="POST">
                        <input type="text" name="id_produs" value="<?php echo $id_produs; ?>" hidden>
                        <input type="submit" class="btn btn-primary " name="buton-sterge" value="Sterge produs" />
                    </form>
                    <form action="modifica-produs.php" method="POST">
                        <input type="text" name="id_produs" value="<?php echo $id_produs; ?>" hidden>
                        <input type="submit" class="btn btn-primary " name="buton-modifica" value="Modifica produs" />
                    </form>
                </div>
            </div>
